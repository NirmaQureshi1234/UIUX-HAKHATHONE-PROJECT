            ...
            <div className="relative text-black ">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                    ...
                    <div className="mt-4 text-gray-500 text-xs md:text-xl flex items-center space-x-3">
                        <Link href="/" className="text-sm text-gray-500 mt-2 flex items-center justify-center space-x-2">
                            Home
                        </Link>
                        <span className="text-gray-500 h-3 mt-1 w-3 text-xs text-center">{'>'}</span>
